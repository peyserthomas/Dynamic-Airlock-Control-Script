    ...
    public partial class Program : MyGridProgram
    {
        ...
        public class Airlock {
            ...
            public void AdditionalHardwareCheck()
            {
                ...
                Program.GridTerminalSystem.GetBlocksOfType(AllGasTanks);
                ...
                Program.GridTerminalSystem.GetBlocksOfType(AllDisplays);
                ...
                Program.GridTerminalSystem.GetBlocksOfType(AllLights);
            ...
            public bool InitialHardwareSetup()
            {
                ...
                {
                    Program.Echo("Provide Interior Door(s)");
                    foreach (IMyDoor Door in AllDoors)
                    {
                        string DoorName = Door.CustomName.ToLower();
                ...
                {
                    Program.Echo("Missing Airlock Air Vent");
                    List<IMyAirVent> AllVents = new List<IMyAirVent>();
                    Program.GridTerminalSystem.GetBlocksOfType(AllVents);
        ...
        public Program()
        {
            InitialSetupComplete = (Storage == "1") ? true : false;
        ...
        public bool CheckIdentificationTags() {
            ...
            //Clear the tags list then repopulate from Custom Data from PB
            IdentifyingTags.Clear();
            IdentifyingTags = PBCustomData.Split(',').ToList();

            return true;
        }//Ends AquireAirlocktags
